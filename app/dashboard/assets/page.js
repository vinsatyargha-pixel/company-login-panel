        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            <tr className="border-b border-[#FFD700]/10">
              ...
              <td className="px-3 py-2 text-right">{formatIDR(summary.amt)}</td>
              ...
              <td className="px-3 py-2 text-right text-green-400">{formatIDR(summary.total_deposit)}</td>
              <td className="px-3 py-2 text-right text-red-400">{formatIDR(summary.total_withdrawal)}</td>
              <td className="px-3 py-2 text-right">{formatNumber(summary.active_member)}</td>
              <td className="px-3 py-2 text-right text-blue-400">{formatIDR(summary.turnover)}</td>
              <td className={`px-3 py-2 text-right ${summary.winlose <= 0 ? 'text-green-400' : 'text-red-400'}`}>{formatIDR(summary.winlose)}</td>
              <td className="px-3 py-2 text-right">{formatIDR(summary.bonus)}</td>
              <td className="px-3 py-2 text-right">{formatIDR(summary.commission)}</td>
              <td className="px-3 py-2 text-right">{formatIDR(summary.cashback)}</td>
              <td className="px-3 py-2 text-right">{formatIDR(summary.adjustment)}</td>
              <td className="px-3 py-2 text-right">{formatIDR(summary.referral)}</td>
            </tr>
          </tbody>
        </table>
      </div>
