...
export default function MemberSpecificationPage() {
  ...
  // ===========================================
  // GET ACTUAL MEMBER ID FROM DATABASE (CASE INSENSITIVE)
  // ===========================================
  const getActualMemberId = async (searchId: string): Promise<string | null> => {
    try {
      // Cari di deposit dengan ilike (case insensitive)
            ...
            <div className="p-4 flex-1 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 200px)' }}>
              ...
              {box.error && !box.loading && (
                <div className="text-center py-12">
                  ...
                  <p className="text-xs text-[#A7D8FF] mt-2">Contoh ID: Memelah1233, surya28, Bradley2020</p>
                </div>
              )}
              ...
              {!box.data && !box.loading && !box.error && (
                <div className="text-center py-12">
                  ...
                  <p className="text-xs text-[#A7D8FF] mt-1">Contoh: Memelah1233, surya28, Bradley2020</p>
                </div>
              )}
            </div>
          </div>
