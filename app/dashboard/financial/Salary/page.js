...
export default function SalaryPage() {
  return (
    <div className="p-6 max-w-7xl mx-auto min-h-screen bg-[#0B1A33] text-white">
      ...
      <div className="flex items-center justify-center h-64 bg-[#1A2F4A] border border-[#FFD700]/30 rounded-lg">
        <div className="text-center">
          <span className="text-8xl block mb-4">💰</span>
          <p className="text-[#FFD700] text-xl">Halaman dalam pengembangan</p>
          <p className="text-[#A7D8FF] mt-2">Salary calculation akan segera hadir</p>
        </div>
      </div>
    </div>
  );
