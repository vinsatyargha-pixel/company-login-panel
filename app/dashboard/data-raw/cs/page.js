...
export default function CsDataRawPage() {
  ...
  return (
    <div className="p-6 w-full min-h-screen bg-[#0B1A33] text-white">
      ...
      <h1 className="text-3xl font-bold text-[#FFD700] mb-4">📥 Import CS Data Raw</h1>
      <p className="text-[#A7D8FF]">Halaman import Customer Service data (dalam pengembangan)</p>
    </div>
  );
}